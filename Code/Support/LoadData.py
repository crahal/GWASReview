...
def load_gwas_cat():
    ...
    Cat_Anc = Cat_Anc[Cat_Anc['Broader'].notnull()]  # jankys?
    ...
    if len(Cat_Anc['Broader'].unique()) != 7:
        print('Something strange going on with Broader! Investigate!')
        print('Perhaps just need to update the dictionary for new terms.')
    Cat_Anc['Broader'] = Cat_Anc['Broader'].str.replace(
